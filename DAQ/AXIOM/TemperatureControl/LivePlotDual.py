...
class LivePlotDual:
    ...
    def update(self, new_temperatures: list, new_humidities: list):
        """
        ...
        if self.lines_temp is None or self.lines_hum is None:
            ...
            for i in range(len(new_temperatures)):
                ...
                self.ax_temp.xaxis.set_major_locator(AutoDateLocator(maxticks=7))
            ...
            for i in range(len(new_humidities)):
                ...
                self.ax_hum.xaxis.set_major_locator(AutoDateLocator(maxticks=7))
