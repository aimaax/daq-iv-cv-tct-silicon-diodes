...
import logging
from config import PELTIER_MAX_CURRENT, PELTIER_MAX_VOLTAGE
# log = logging.child_logger(__file__)
log = logging.getLogger("AXIOM").getChild(__file__)
...
class tsx3510P:
    ...
    def __init__(self, address):
        ...
        try:  
            ...
            raise RuntimeError('Aim TTi TSX3510P voltmeter is not connected!')

        self.max_current = PELTIER_MAX_CURRENT
        self.max_voltage = PELTIER_MAX_VOLTAGE
